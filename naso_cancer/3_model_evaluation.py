...
def main(name):
    ...
    matfiles = []
    with open("/wangshuo/zhaox/ImageProcessing/naso_cancer/_data/fileidx/%s.files" % name) as f:
        for line in f:
    ...
    with open('/wangshuo/zhaox/ImageProcessing/naso_cancer/_data/roc/121model.%s.roc.csv' % name, 'w') as f:
